 ...
 */
public class BAMRunningControlProcess implements IFlowControlProcess{
    
    private Step step;
    private Map input;

    public BAMRunningControlProcess() {
    }
    ...
    public Object process() throws ValidateException, GeneralException {
        try {
            ...
            params.put(RestCallControlProcess.PARAM_BODY, "{ \"transactionId\": \"5a6d833a-b9f3-4296-a243-f3aa69b5b97e\", \"country\": \"Brazil\", \"version\": \"1.0.0\", \"errorDescription\": \"\", \"interface\": \"purchaseorder\", \"project\": \"Coupa\", \"status\": \"RUNNING\", \"payload\": \"\" }");
